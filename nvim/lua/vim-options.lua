...
vim.keymap.set("n", "<gt>", ":tabnext<CR>", { noremap = true, silent = true, desc = "Next Tab Page" }) -- Go to next tab page
vim.keymap.set("n", "<c-r>", ":tabprevious<CR>", { noremap = true, silent = true, desc = "Previous Tab Page" }) -- Go to previous tab page
